...
const Login = () => {
    ...
    const handleSubmit = async e => {
       ...
       if([email, password].includes('')){
        setError({
            msg: 'debe ingresar usuario y contraseña',
            error: true
        })
        return
       }
  ...
  return (
    <>
        <h1 className="text-sky-600 font-black text-3xl capitalize">Inicia sesion y administra tus <span className="text-slate-700">proyectos</span></h1>
        <form 
        ...
        className='flex justify-center items-center cursor-pointer bg-gray-400'> click para saber Acerca de este proyecto:</footer>
